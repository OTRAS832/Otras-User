...
const endpoints = {
    ...
    getAllPQP: "api/pqp/get/allPQPs",
    getAllAnswerKeys: "api/answerkey/getallAnswerKeys",
    getAllResults: "api/result/all",
    ...
    DownloadAdminCard: "api/admit-card/all-by-candidate?candidateProfileId=",
    getuserDataOtr: "api/admit-card/all-by-candidate?candidateProfileId=",
    getCategories: "jobpost/categories",
    getResults: "examAssignment/resultsByCandidate?candidateId=",
    getStudentResults: "examAssignment/getResultByRollNo?examRollNo=",
